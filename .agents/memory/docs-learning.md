# NEAR Protocol Documentation - Learning Resources
...
- [Build on Aurora](https://docs.near.org/aurora/build-on-aurora.md): Learn how to build on Aurora EVM compatible chain
...
### Core Concepts
- [Understanding Data Flow](https://docs.near.org/quest/data-flow.md): Learn how data moves through NEAR Protocol - understand transactions, receipts, gas fees, and how the blockchain processes your requests step by step
...
- [Understanding NEAR Primitives](https://docs.near.org/quest/primitives.md): Learn about NEAR Protocol's primitives - fundamental building blocks that make Web3 applications possible
- [Understanding Smart Contracts](https://docs.near.org/quest/smart-contracts.md): Learn about smart contracts - the automated programs that power Web3 applications
